...
def data_set_split(src_data_folder, target_data_folder, train_scale=0.8, test_scale=0.2):
    '''
    读取源数据文件夹，生成划分好的文件夹，分为trian、test两个个文件夹进行
    ...
    for class_name in class_names:
        ...
        test_folder = os.path.join(os.path.join(target_data_folder, 'valid'), class_name)
...
if __name__ == '__main__':
    # 源文件路径
    src_data_folder = "trash"
    # 目标文件路径
    target_data_folder = "waste_big"
