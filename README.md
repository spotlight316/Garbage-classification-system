...
二、特别说明：
1\. 由于大小问题，源数据集图片文件无法上传，请自行收集图片	
2\. 收集图片，例如“冰激凌”，“铅笔”等物品的图片放进一个源数据集文件夹，运行dataset_split程序生成划分好的文件夹，分为trian、test两个文件夹进行
3\. 运行main文件会自动打开摄像头，把物品例如冰激凌，铅笔(数据集文件中含有的物品类别)放在摄像头前会自动识别出物品类别
